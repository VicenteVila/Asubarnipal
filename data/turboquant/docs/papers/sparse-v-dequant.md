...
- **@Madreag** — RTX 5090, Qwen3.5-27B Q6_K (2026-03-26): turbo3 K+V passing math, factual, and code gen benchmarks. NIAH 6/6 exact retrieval. [Full optimized CUDA release](https://github.com/ggml-org/llama.cpp/discussions/20969#discussioncomment-16404751) (2026-04-01): Sparse V control test proves zero quality impact (turbo3 PPL 6.7251 ON and OFF, identical). +4.6% speed at 32K. Skip rates: 96.8-99.7% at threshold 5e-3 (turbo3/4). Cross-validated on 4 GPUs (SM86x2/SM89/SM120), 1,351+ iterations.
